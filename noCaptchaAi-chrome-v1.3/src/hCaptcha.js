(async () => {
  ...
  (async () => {
    ...
    async function solve() {
      ...
      const { target, cells, images, example, examples, choices } =
        await onTaskReady();
      ...
      if (logs) console.log(type, target, cells, images, example, choices);
    ...
    async function handleMulti(example, images) {
      ...
      return new Promise(async (resolve) => {
        const check_interval = setInterval(async function () {
          ...
          if (isGrid()) {
            ...
            await handleMulti(example, images);
          } else if (isBbox()) {
